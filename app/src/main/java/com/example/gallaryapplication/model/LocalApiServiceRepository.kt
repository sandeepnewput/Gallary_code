            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    try {
                        ...
                        imageList.add(MediaModel(uri.toString(), name, size, MediaType.IMAGE))
            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    try {
                        ...
                        videoList.add(MediaModel(uri.toString(), name, size, MediaType.VIDEO))
            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    try {
                        ...
                        musicList.add(MediaModel(uri.toString(), name, size, MediaType.MUSIC))
